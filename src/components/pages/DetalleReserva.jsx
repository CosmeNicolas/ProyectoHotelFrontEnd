  ...
  return (
    <section className="main fondo-formulario-Reserva ">
      <div className="mt-5 pt-2 ">
        <h1 className="text-center tituloReservaCard text-light ">
          Tu Reserva🛎️
        </h1>
      </div>
        ...
        <article className="">
          <Card style={{ width: "18rem" }}>
            ...
            <ListGroup className="list-group-flush">
              <ListGroup.Item>
                Reserva con el correo de : {reserva.email}
              </ListGroup.Item>
              <ListGroup.Item>Nro. Habitacion: {reserva.numero}</ListGroup.Item>
              <ListGroup.Item>Precio: ${reserva.precio}</ListGroup.Item>
              <ListGroup.Item>
                Fecha de Ingreso: {reserva?.fechaIngreso?.slice(0, 10)}
              </ListGroup.Item>
              <ListGroup.Item>
                Fecha de Salida: {reserva?.fechaSalida?.slice(0, 10)}
              </ListGroup.Item>
            </ListGroup>
