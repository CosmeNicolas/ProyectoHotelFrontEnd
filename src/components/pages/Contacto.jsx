        ...
        <Row className="justify-content-center">
          ...
          <Col xs={12} sm={12} lg={6} className="texto-FormContacto py-3">
            <h4>
              ...
              Av. Gral. Paz 576, San Miguel de Tucuman, CP 4000
            </h4>
            <Form className="text-center">
              <Form.Group>
                <InputGroup className="py-3">
                  <InputGroup.Text id="nombreContacto">Nombre</InputGroup.Text>
                  <Form.Control placeholder="Juan" aria-label="nombreContacto" className="color-inputs"/>
                </InputGroup>
                <InputGroup>
                  <InputGroup.Text id="apellidoContacto">
                    Apellido
                  </InputGroup.Text>
                  <Form.Control placeholder="Garcia" aria-label="apellidoContacto" className="color-inputs"/>
                </InputGroup>
                <InputGroup className="py-3">
